...
jQuery( document ).ready(function( $ ) {
  ...
  $('#user-modal, #mentor-modal').on('show.bs.modal', function(e) {
    ...
    if ($(this).attr('id') == 'user-modal') {
      ...
      var hourlyrate    = $(e.relatedTarget).data('hourlyrate');
      var qualification = $(e.relatedTarget).data('qualification');
      var mothert       = $(e.relatedTarget).data('mothert');
      var lang          = $(e.relatedTarget).data('lang');
      var bapic          = $(e.relatedTarget).data('bapic');
      var bbpic          = $(e.relatedTarget).data('bbpic');
      var bcpic          = $(e.relatedTarget).data('bcpic');
      var bdpic          = $(e.relatedTarget).data('bdpic');
      var bepic          = $(e.relatedTarget).data('bepic');
      var premium        = $(e.relatedTarget).data('premium');
      var free        = ' ';
      var premiumtxt     = $(e.relatedTarget).data('premiumtxt');
      var accounttype    = $(e.relatedTarget).data('accounttype');
      // alert(accounttype);
      ...
      $(e.currentTarget).find('.hourlyrate').html(hourlyrate);
      $(e.currentTarget).find('.qualification').html(qualification);
      $(e.currentTarget).find('.mothert').html(mothert);
      $(e.currentTarget).find('.lang').html(lang);
      $(e.currentTarget).find('.bapic').html(bapic);
      $(e.currentTarget).find('.bbpic').html(bbpic);
      $(e.currentTarget).find('.bcpic').html(bcpic);
      $(e.currentTarget).find('.bdpic').html(bdpic);
      $(e.currentTarget).find('.bepic').html(bepic);
      if(accounttype == 'premium'){
      $(e.currentTarget).find('.premium').html(premium);
      $(e.currentTarget).find('.premiumtxt').html(premiumtxt);
      }else{
      $(e.currentTarget).find('.premium').html(free);
      $(e.currentTarget).find('.premiumtxt').html();
      }
    } 
