					...
					<div class="tab-pane fade show active" id="v-pills-pages">
						...
						<section>
					      	...
					      	<div class="row">
					      		...
					      		<form method="POST" action="{{ url('/admin/update-content/10') }}" enctype="multipart/form-data" class="edit-content-form">
					      		@csrf
					      				...
					      				<div class="edit-body">
					      					...
					      					<div class="edit-section-body">
						      					<div class="edit-body-row row no-gutters align-items-center gray-bg">
						      						...
						      						<div class="brown pull-left">Thank You</div>
						      					</div>
						      					<div class="edit-body-row edit-hide">
						      						<span>Hide Section?</span>
						      						<div class="custom-control custom-checkbox">
														<input name="thank-you-hidden" type="checkbox" class="custom-control-input" id="edit-hide-tos" @if($showSection['thank-you'] == 'hide')
															checked="checked"
														@endif
														>
														<label class="custom-control-label" for="edit-hide-tos"></label>
													</div>
							      				</div>
							      				<div class="edit-body-row">
						      						<div class="edit-image-container">
						      							...
						      							<div class="padT10">
															<img class="photo-frame" src="{{ $passedContents['ty-background'] ? $passedContents['ty-background'] : '/images/image-placeholder.jpg' }}" alt="">
														</div>
							      						<div class="padT10">
															<label for="ty-bg-img" class="fileBtn">
															    Choose File
															</label>
															<input name="ty-background" class="file-upload hide" id="ty-bg-img" type="file" value="{{ $passedContents['ty-background'] }}" />
															<span class="fileName">{{ $passedContents['ty-background'] ? $passedContents['ty-background'] : 'No file chosen'}}</span>
														</div>
													</div>
						      					</div>
						      					<div class="edit-body-row">
						      						<div class="edit-title-container">
							      						...
							      						<div class="padT10">
						      								<input name="ty-heading" type="text" class="edit-title-input col-12 padLR10" value="{{ $passedContents['ty-heading'] }}">
						      							</div>
						      						</div>
					      						</div>
						      					<div class="edit-body-row">
						      						<div class="content-container">
						      							...
						      							<div class="padT10">
														    <textarea name="ty-content" class="mceEditor">
						      					...
						      					<div class="edit-body-row">
                                                    <div class="edit-button-container">
														<div class="m-1">
                                                            ...
                                                            <input name="ty-cta-btn-text" type="text" class="edit-title-input padLR10" value="{{ $passedContents['ty-cta-btn-text'] }}">
														</div>														
                                                    </div>
                                                </div>
						      				</div>						      				
					      		...
					      		<!-- EDIT CONTENT FORM END -->
					      			<div class="white-box-shadow">
					      				...
					      				<form method="POST" action="{{ url('/admin/update-meta/10') }}">
					      				@csrf
						      				<div class="edit-body">
						      					<div class="edit-title-container">
