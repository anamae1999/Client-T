					...
					<div class="tab-pane fade show active" id="v-pills-pages">
						...
						<section>
					      	...
					      	<div class="row">
					      		...
					      		<form method="POST" action="{{ url('/admin/update-content/4') }}" enctype="multipart/form-data" class="edit-content-form">
                                	@csrf
					      		<div class="col-xl-9">
					      				...
					      				<div class="edit-body">
					      					...
					      					<div class="edit-section-body">
						      					...
						      					<div class="edit-body-row edit-hide">
						      						...
						      						<div class="custom-control custom-checkbox">
														<input name="blog-main-hidden" type="checkbox" class="custom-control-input" id="edit-hide-intro"
															@if($showSection['blog-main'] == 'hide')
																checked="checked"
															@endif
														>
						      					...
						      					<div class="edit-body-row">
						      						<div class="edit-title-container">
							      						...
							      						<div class="padT10">
						      								<input name="blog-main-title" type="text" class="edit-title-input col-12 padLR10" value="{{ $passedContents['blog-main-title'] }}">
						      							</div>
						      						</div>
						      						<div class="edit-content-container padT10">
							      						<span>Content</span>
						      							<div class="padT10">
														    <textarea name="blog-main-content" id="content-editor" class="mceEditor">{{ $passedContents['blog-main-content'] }}</textarea>
														</div>
													</div>
						      					</div>
						      				</div>
					      					...
					      					<div class="edit-section-body">
						      					<div class="edit-body-row row no-gutters align-items-center gray-bg">
						      						...
						      						<div class="brown pull-left">Filter section</div>
						      					</div>
						      					<div class="edit-body-row edit-hide">
						      						<span>Hide Section?</span>
						      						<div>
							      						<div class="custom-control custom-checkbox">
															<input name="blog-filter-hidden" type="checkbox" class="custom-control-input" id="edit-hide-blogfilter"
																@if($showSection['blog-filter'] == 'hide')
																	checked="checked"
																@endif
															>
															<label class="custom-control-label" for="edit-hide-blogfilter"></label>
														</div>
													</div>
						      					</div>
						      					<div class="edit-body-row">
						      						<div class="edit-title-container">
							      						...
							      						<div class="padT10">
						      								<input name="blog-filter-text" type="text" class="edit-title-input col-12 padLR10" value="{{ $passedContents['blog-filter-text'] }}">
						      							</div>
						      						</div>
						      					</div>
						      				</div>
					      		...
					      		<!-- EDIT CONTENT FORM END -->
					      			<div class="white-box-shadow">
					      				...
					      				<form method="POST" action="{{ url('/admin/update-meta/4') }}">
					      				@csrf
						      				<div class="edit-body">
						      					<div class="edit-title-container">
