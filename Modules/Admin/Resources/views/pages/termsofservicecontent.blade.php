			...
			<div class="dashboard-tab-content padLR60">
			    <div class="tab-content" id="dashboard-tab-content">
					<div class="tab-pane fade show active" id="v-pills-pages">
						...
						<section>
					      	<h2>Edit Terms of Service Page</h2>
					      	<div class="row">
					      		<!-- EDIT CONTENT FORM START -->
					      		<form method="POST" action="{{ url('/admin/update-content/7') }}" enctype="multipart/form-data" class="edit-content-form">
					      		@csrf
					      				...
					      				<div class="edit-body">
					      					...
					      					<div class="edit-section-body">
						      					<div class="edit-body-row row no-gutters align-items-center gray-bg">
						      						...
						      						<div class="brown pull-left">Terms of Service</div>
						      					</div>
						      					<div class="edit-body-row edit-hide">
						      						<span>Hide Section?</span>
						      						<div class="custom-control custom-checkbox">
														<input name="terms-of-service-hidden" type="checkbox" class="custom-control-input" id="edit-hide-tos" @if($showSection['terms-of-service'] == 'hide')
															checked="checked"
														@endif
														>
						      					...
						      					<div class="edit-body-row">
						      						<div class="edit-title-container">
							      						...
							      						<div class="padT10">
						      								<input name="tos-heading" type="text" class="edit-title-input col-12 padLR10" value="{{ $passedContents['tos-heading'] }}">
						      							</div>
						      						</div>
					      						</div>
						      					<div class="edit-body-row">
						      						<div class="content-container">
						      							...
						      							<div class="padT10">
														    <textarea name="tos-content" class="mceEditor">
														    	{{ $passedContents['tos-content'] }}
														    </textarea>
														</div>
													</div>
						      					</div>
					      		...
					      		<!-- EDIT CONTENT FORM END -->
					      			<div class="white-box-shadow">
					      				...
					      				<form method="POST" action="{{ url('/admin/update-meta/7') }}">
					      				@csrf
						      				<div class="edit-body">
						      					<div class="edit-title-container">
