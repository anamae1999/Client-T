            ...
            <div class="dashboard-tab-content padLR60"> 
                ...
                <div id="loadingDiv">
                    ...
                    <div class="tab-pane fade show active">
                                ...
                                <div class="d-flex flex-row flex-wrap align-items-center px-4 px-sm-5 pt-4 pb-3 row no-gutters">
                                    <div class="col-12">
                                        <div class="pb-3 col-details">
                                            <h4 class="brown m-0">Account Settings for Parent</h4>
                                        </div>
                                    </div>
                                </div>
                                <form class="admin-accset" method="post" action="{{ url('/parents/update-settings') }}" enctype="multipart/form-data" class="admin-accset" autocomplete="off">
                                @csrf
                                @method('patch')
                                    <div class="row no-gutters">
                        ...
                        <div class="row no-gutters justify-content-center">
                            <div class="col-12 shadow white-bg rounded my-3">
                                <div id="payment" class="row no-gutters">
                                    <div class="col-md-12 p-3 p-sm-5"> 
                                        ...
                                        @if(isset(Auth::user()->guardianProfile->job_description))
                                                    ...
                                                    <div class="row">
                                                        <div class="col-11 col-sm-12 col-xl-9 col-lg-11 mb-0 sub-pay-card-wrap">
                                                            <table class="sub-pay-container sub-pay-card col-12">
                                                                <tbody>
                                                                    @if($settings->parent_1mo != 0 || $settings->parent_3mo != 0)
                                                                        @if($settings->parent_1mo != 0)
                                                                        <tr class="sub-pay-row">
                                                                            <td scope="row">
                                                                                <div class="custom-control custom-radio-green custom-control-inline test">
                                                                                    <input type="radio" id="1month" name="subscription" class="custom-control-input" value="1mo">
                                                                        ...
                                                                        @if($settings->parent_3mo != 0)
                                                                        <tr class="sub-pay-row help-text-city-container help-text-pay">
                                                                            <td scope="row">
                                                                                <div class="custom-control custom-radio-green custom-control-inline test">
                                                                                    <input type="radio" id="3month" name="subscription" class="custom-control-input" value="3mo">
                                                                                    <label class="custom-control-label" for="3month">3 months</label>
                                                                                </div>
                                                                            </td>
                                                                            <td>€ {{ $settings->parent_3mo }}</td>
                                                                            <td>(€ {{ round(($settings->parent_3mo / 3), 2) }} per month)
                                                                                @if($settings->payment_tooltip)
                                            ...
                                            <div class="col-md-12">
                                                <div class="row align-items-center">
                                                    <div class="col-md-auto col-sm-12 mb-3 mb-md-0 px-0">          
                                                        <a href="/parents/dashboard" class="custom-btn btn-white py-2">Profile</a>
                                                    </div>                                                    
                                                </div>
                                            </div>                                          
                                        @endif
...
<div id="deleteUserModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content p-2">
            ...
            <form method="POST" action='{{ url("/parents/delete") }}'>   
            @csrf   
...
<div id="suspendUserModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content p-2">
            ...
            <form method="POST" action='{{ url("/parents/deactivate") }}'>  
            @csrf            
                <input type="hidden" name="userId"> 
                <div class="modal-footer">   
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
