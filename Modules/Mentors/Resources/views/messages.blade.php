@extends('mentors::layouts.master-messaging') 
...
<section class="gray-bg">
    <div class="container-fluid">
        <div class="row no-gutters">
            ...
            <div class="dashboard-tab-content padLR30">                
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content p-2">
            ...
            <div class="modal-body d-flex">
                ...
                <p>Do you really want to delete "<span class="user-name"></span>" from your contact list?</p>
            </div>
